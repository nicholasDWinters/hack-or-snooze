...
class StoryList {
  ...
  async addStory(currentUser, { title, author, url }) {
    ...
    try {
      ...
      console.log('unable to create new story - ', e);
    }
  }
}
...
class User {
  ...
  async addToFavorites(storyId) {
    try {
      ...
      console.log('unable to favorite - ', e);
    }
  }

  async deleteFromFavorites(storyId) {
    try {
      console.log(storyId);
      let token = this.loginToken;
      const response = await axios({
      ...
      console.log('unable to delete favorite - ', e);
    }
  }

  async deleteFromStories(storyId) {
    try {
      console.log(storyId);
      let token = this.loginToken;
      const response = await axios({
      ...
      console.log('unable to delete story - ', e);
    }
  }
}
